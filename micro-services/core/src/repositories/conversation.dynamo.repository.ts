...
export type ConversationUpdates<T extends ConversationType> =
  Conversation<T> extends GroupConversation ? Partial<Pick<Conversation<T>, "imageMimeType">> : Conversation<T> extends MeetingConversation ? Partial<Pick<MeetingConversation, "imageMimeType" | "name" | "outcomes">> : Record<string, unknown>;
