...
const TYPES = {
  ...
  OrganizationUserRelationshipServiceInterface: Symbol.for("OrganizationUserRelationshipServiceInterface"),
  ...
  OrganizationUserRelationshipRepositoryInterface: Symbol.for("OrganizationUserRelationshipRepositoryInterface"),
