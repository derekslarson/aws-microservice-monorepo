...
export const handler = async (event: APIGatewayProxyEventV2): Promise<APIGatewayProxyStructuredResultV2> => {
  try {
    loggerService.trace("createUser called", { event }, "createUser handler");
    ...
    loggerService.error("Catastrophic error in createUser handler", { error, event }, "createUser handler");
