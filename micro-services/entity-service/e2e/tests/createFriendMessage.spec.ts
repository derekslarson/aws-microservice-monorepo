  ...
  describe("under normal conditions", () => {
    ...
    beforeEach(async () => {
      ...
      ([ { conversationUserRelationship }, { conversationUserRelationship: conversationUserRelationshipTwo } ] = await Promise.all([
        createConversationUserRelationship({ conversationId: friendship.id, userId, role: Role.Admin }),
        createConversationUserRelationship({ conversationId: friendship.id, userId: mockUserId, role: Role.Admin }),
      ]));
    });
