...
import { CognitoIdentityServiceProvider, DynamoDB, EventBridge, S3, SNS, SSM, TranscribeService } from "aws-sdk";
...
export const eventBridge = new EventBridge({ region: "us-east-1" });
